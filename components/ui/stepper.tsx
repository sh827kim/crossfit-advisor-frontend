    ...
    Stepper: {
      ...
      Step: ({ children, className, icon, ...props }) => {
        ...
        const indicatorClasses = cn(
          "rounded-full",
          indicatorClassName,
          dataState === "active" && indicatorActiveClassName,
          dataState === "completed" && indicatorCompletedClassName,
          dataState === "inactive" && indicatorInactiveClassName
        )

        const separatorExtraClasses = cn(
          separatorClassName,
          dataState === "completed" && separatorCompletedClassName
        )
            ...
            >
              ...
              {variant === "horizontal" && labelOrientation === "vertical" && (
                <StepperSeparator
                  ...
                  className={separatorExtraClasses}
                />
              )}
...
const StepperSeparator = ({
  ...
  return (
    <hr
      ...
      tabIndex={-1}
      className={cn(classForSeparator({ orientation, labelOrientation }), className)}
    />
  )
}
